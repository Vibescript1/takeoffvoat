...
import VoatGallery from "../VoatGallery";
import "./index.css";
import {
  Code,
  Megaphone,
  ...
  blogData = [
    {
      ...
      shortDescription:
        "Discover the latest trends in digital marketing that are shaping the industry and driving business growth.",
      fullDescription:
    ...
    },
    {
      ...
      shortDescription:
        "Learn the essential best practices for modern web development that ensure scalable and maintainable code.",
      fullDescription:
    ...
    },
    {
      ...
      fullDescription:
        "Creative branding solutions that make your business stand out with a memorable and impactful identity. Understanding the psychology of color, typography, and visual elements is crucial for building a strong brand presence. The process involves thorough market research, competitor analysis, and understanding your target demographic's preferences and behaviors. Successful brand identity design goes beyond just creating a logo; it encompasses the entire visual language that communicates your brand's values, mission, and personality across all touchpoints.",
      author: "VOAT Network",
      date: "March 5, 2024",
    ...
    },
    {
      ...
      shortDescription:
        "Professional mobile app development services to create stunning applications for iOS and Android platforms.",
      fullDescription:
  ...
  render() {
    ...
    return (
      <>
        ...
        {/* Mega submenu positioned under navbar */}
        <MegaSubmenu />
            ...
            <div className="landing-page-container">
              ...
              <div className="landing-page-blog-grid">
                {this.blogData
                  ...
                  .map((blog, index) => {
                    const actualIndex =
                      (this.state.currentBlogPage - 1) *
                        this.state.blogsPerPage +
                      index;
                    return (
                      <div
                        key={actualIndex}
                      ...
                      >
                        ...
                        <div className="description">
                          ...
                          <p
                            className={
                              this.state.expandedBlogs[actualIndex]
                                ? "expanded"
                                : "collapsed"
                            }
                          >
              ...
              <div className="landing-page-blog-pagination">
                <div className="landing-page-pagination-info">
                  ...
                  of {this.blogData.length} posts
                </div>
                <div className="landing-page-pagination-controls">
                  <button
                    className={`landing-page-pagination-btn ${
                      this.state.currentBlogPage === 1 ? "disabled" : ""
                    }`}
                    onClick={() =>
                      this.handleBlogPageChange(this.state.currentBlogPage - 1)
                    }
                  ...
                  {Array.from(
                    {
                      length: Math.ceil(
                        this.blogData.length / this.state.blogsPerPage
                      ),
                    },
                    (_, i) => i + 1
                  ).map((pageNum) => (
                    <button
                      key={pageNum}
                      className={`landing-page-pagination-btn ${
                        this.state.currentBlogPage === pageNum ? "active" : ""
                      }`}
                  ...
                  <button
                    className={`landing-page-pagination-btn ${
                      this.state.currentBlogPage ===
                      Math.ceil(this.blogData.length / this.state.blogsPerPage)
                        ? "disabled"
                        : ""
                    }`}
                    onClick={() =>
